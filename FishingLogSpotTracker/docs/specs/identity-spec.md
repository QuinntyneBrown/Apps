...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FishingLogSpotTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FishingLogSpotTracker",
    "aud": "FishingLogSpotTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FishingLogSpotTracker",
        "Audience": "FishingLogSpotTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@fishing-log-spot-tracker.local |
| Password | Admin123! |
| Roles | Admin |
