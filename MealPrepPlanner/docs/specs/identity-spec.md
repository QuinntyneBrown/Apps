...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MealPrepPlanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MealPrepPlanner",
        "Audience": "MealPrepPlanner.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@meal-prep-planner.local |
| Password | Admin123! |
| Roles | Admin |
