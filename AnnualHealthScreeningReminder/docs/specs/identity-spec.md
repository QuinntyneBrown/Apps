...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the AnnualHealthScreeningReminder system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "AnnualHealthScreeningReminder",
    "aud": "AnnualHealthScreeningReminder.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "AnnualHealthScreeningReminder",
        "Audience": "AnnualHealthScreeningReminder.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@annual-health-screening-reminder.local |
| Password | Admin123! |
| Roles | Admin |
