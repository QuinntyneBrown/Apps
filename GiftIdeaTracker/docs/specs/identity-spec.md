...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the GiftIdeaTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    "Jwt": {
        ...
        "Issuer": "GiftIdeaTracker",
        "Audience": "GiftIdeaTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@gift-idea-tracker.local |
| Password | Admin123! |
| Roles | Admin |
