...
import { RecipientsService, GiftIdeasService } from '@lib/shared';
import { RecipientCard, RecipientDialog, RecipientDialogResult } from '@lib/shared';
import { Recipient, CreateRecipientRequest, UpdateRecipientRequest } from '@lib/shared';
