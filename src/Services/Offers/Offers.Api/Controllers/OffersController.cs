...
public class OffersController : ControllerBase
{
    ...
    {
        _logger.LogInformation("Getting all offers");
    ...
    public async Task<ActionResult<OfferDto>> CreateOffer(
        [FromBody] CreateOfferCommand command,
        CancellationToken cancellationToken)
    {
        _logger.LogInformation("Creating offer for application {ApplicationId}", command.ApplicationId);
