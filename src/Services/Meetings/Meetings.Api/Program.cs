...
builder.AddSqlServerDbContext<MeetingsDbContext>("MeetingNotesActionItemTrackerDb");
builder.Services.AddScoped<IMeetingsDbContext>(p => p.GetRequiredService<MeetingsDbContext>());
