...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MarriageEnrichmentJournal system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "MarriageEnrichmentJournal",
    "aud": "MarriageEnrichmentJournal.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MarriageEnrichmentJournal",
        "Audience": "MarriageEnrichmentJournal.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@marriage-enrichment-journal.local |
| Password | Admin123! |
| Roles | Admin |
