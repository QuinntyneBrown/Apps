...
namespace RetirementSavingsCalculator.Api.Features.Roles;
...
public class CreateRoleCommandHandler : IRequestHandler<CreateRoleCommand, RoleDto>
{
    ...
    public CreateRoleCommandHandler(IRetirementSavingsCalculatorContext context, ITenantContext tenantContext, ILogger<CreateRoleCommandHandler> logger)
    {
        _context = context;
