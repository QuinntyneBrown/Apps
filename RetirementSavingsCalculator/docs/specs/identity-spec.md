...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the RetirementSavingsCalculator system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "RetirementSavingsCalculator",
    "aud": "RetirementSavingsCalculator.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "RetirementSavingsCalculator",
        "Audience": "RetirementSavingsCalculator.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@retirement-savings-calculator.local |
| Password | Admin123! |
| Roles | Admin |
