...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the GiftRegistryOrganizer system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "GiftRegistryOrganizer",
    "aud": "GiftRegistryOrganizer.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "GiftRegistryOrganizer",
        "Audience": "GiftRegistryOrganizer.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@gift-registry-organizer.local |
| Password | Admin123! |
| Roles | Admin |
