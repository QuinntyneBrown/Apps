...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the ConversationStarterApp system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "ConversationStarterApp",
    "aud": "ConversationStarterApp.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "ConversationStarterApp",
        "Audience": "ConversationStarterApp.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@conversation-starter-app.local |
| Password | Admin123! |
| Roles | Admin |
