...
public class UpdateUserCommandHandler : IRequestHandler<UpdateUserCommand, UserDto?>
{
    ...
    public UpdateUserCommandHandler(IPersonalMissionStatementBuilderContext context, IPasswordHasher passwordHasher, ILogger<UpdateUserCommandHandler> logger)
    {
        _context = context;
