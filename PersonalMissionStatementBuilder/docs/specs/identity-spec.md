...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PersonalMissionStatementBuilder system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PersonalMissionStatementBuilder",
    "aud": "PersonalMissionStatementBuilder.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PersonalMissionStatementBuilder",
        "Audience": "PersonalMissionStatementBuilder.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@personal-mission-statement-builder.local |
| Password | Admin123! |
| Roles | Admin |
