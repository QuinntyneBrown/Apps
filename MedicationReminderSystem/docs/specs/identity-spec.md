...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MedicationReminderSystem system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "MedicationReminderSystem",
    "aud": "MedicationReminderSystem.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MedicationReminderSystem",
        "Audience": "MedicationReminderSystem.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@medication-reminder-system.local |
| Password | Admin123! |
| Roles | Admin |
