...
namespace MedicationReminderSystem.Api.Features.Users;
...
public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, UserDto>
{
    ...
    public CreateUserCommandHandler(IMedicationReminderSystemContext context, ITenantContext tenantContext, IPasswordHasher passwordHasher, ILogger<CreateUserCommandHandler> logger)
    {
        _context = context;
