...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the BBQGrillingRecipeBook system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "BBQGrillingRecipeBook",
    "aud": "BBQGrillingRecipeBook.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "BBQGrillingRecipeBook",
        "Audience": "BBQGrillingRecipeBook.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@bbq-grilling-recipe-book.local |
| Password | Admin123! |
| Roles | Admin |
