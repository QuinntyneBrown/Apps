...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MortgagePayoffOptimizer system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "MortgagePayoffOptimizer",
    "aud": "MortgagePayoffOptimizer.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MortgagePayoffOptimizer",
        "Audience": "MortgagePayoffOptimizer.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@mortgage-payoff-optimizer.local |
| Password | Admin123! |
| Roles | Admin |
