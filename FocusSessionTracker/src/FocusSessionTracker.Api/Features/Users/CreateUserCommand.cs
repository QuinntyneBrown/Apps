...
public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, UserDto>
{
    ...
    public CreateUserCommandHandler(IFocusSessionTrackerContext context, ITenantContext tenantContext, IPasswordHasher passwordHasher, ILogger<CreateUserCommandHandler> logger)
    {
        _context = context;
