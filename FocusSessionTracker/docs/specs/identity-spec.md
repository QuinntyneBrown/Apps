...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FocusSessionTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FocusSessionTracker",
    "aud": "FocusSessionTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FocusSessionTracker",
        "Audience": "FocusSessionTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@focus-session-tracker.local |
| Password | Admin123! |
| Roles | Admin |
