...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the HomeMaintenanceSchedule system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "HomeMaintenanceSchedule",
    "aud": "HomeMaintenanceSchedule.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "HomeMaintenanceSchedule",
        "Audience": "HomeMaintenanceSchedule.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@home-maintenance-schedule.local |
| Password | Admin123! |
| Roles | Admin |
