...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PhotographySessionLogger system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PhotographySessionLogger",
    "aud": "PhotographySessionLogger.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PhotographySessionLogger",
        "Audience": "PhotographySessionLogger.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@photography-session-logger.local |
| Password | Admin123! |
| Roles | Admin |
