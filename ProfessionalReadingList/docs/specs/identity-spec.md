...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the ProfessionalReadingList system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "ProfessionalReadingList",
    "aud": "ProfessionalReadingList.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "ProfessionalReadingList",
        "Audience": "ProfessionalReadingList.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@professional-reading-list.local |
| Password | Admin123! |
| Roles | Admin |
