...
@Component({
  ...
  template: `
    <mat-toolbar color="primary" class="header">
      <span class="header__title">Professional Reading List</span>
      <nav class="header__nav">
        ...
        <a mat-button routerLink="/notes" routerLinkActive="header__nav-link--active" class="header__nav-link">
          Notes
        </a>
        <a mat-button routerLink="/progress" routerLinkActive="header__nav-link--active" class="header__nav-link">
          Reading Progress
        </a>
      </nav>
    </mat-toolbar>
