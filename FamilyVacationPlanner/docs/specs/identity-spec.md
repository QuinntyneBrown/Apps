...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FamilyVacationPlanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FamilyVacationPlanner",
    "aud": "FamilyVacationPlanner.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FamilyVacationPlanner",
        "Audience": "FamilyVacationPlanner.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@family-vacation-planner.local |
| Password | Admin123! |
| Roles | Admin |
