...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MeetingNotesActionItemTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "MeetingNotesActionItemTracker",
    "aud": "MeetingNotesActionItemTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MeetingNotesActionItemTracker",
        "Audience": "MeetingNotesActionItemTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@meeting-notes-action-item-tracker.local |
| Password | Admin123! |
| Roles | Admin |
