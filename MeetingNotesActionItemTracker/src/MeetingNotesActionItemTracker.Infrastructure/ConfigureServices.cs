...
public static class ConfigureServices
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<MeetingNotesActionItemTrackerContext>(options =>
        {
            options.UseSqlServer(connectionString, sqlOptions =>
            {
                sqlOptions.MigrationsAssembly(typeof(MeetingNotesActionItemTrackerContext).Assembly.FullName);
