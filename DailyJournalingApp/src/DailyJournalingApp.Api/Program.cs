...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "DailyJournalingApp API",
        Version = "v1",
        Description = "API for managing daily journal entries, prompts, and mood tracking",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<DailyJournalingAppContext>();
