...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the DailyJournalingApp system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "DailyJournalingApp",
    "aud": "DailyJournalingApp.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "DailyJournalingApp",
        "Audience": "DailyJournalingApp.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@daily-journaling-app.local |
| Password | Admin123! |
| Roles | Admin |
