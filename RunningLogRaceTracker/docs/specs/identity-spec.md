...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the RunningLogRaceTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "RunningLogRaceTracker",
    "aud": "RunningLogRaceTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "RunningLogRaceTracker",
        "Audience": "RunningLogRaceTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@running-log-race-tracker.local |
| Password | Admin123! |
| Roles | Admin |
