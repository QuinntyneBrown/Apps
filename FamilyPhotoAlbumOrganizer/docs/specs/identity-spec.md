...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FamilyPhotoAlbumOrganizer system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FamilyPhotoAlbumOrganizer",
    "aud": "FamilyPhotoAlbumOrganizer.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FamilyPhotoAlbumOrganizer",
        "Audience": "FamilyPhotoAlbumOrganizer.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@family-photo-album-organizer.local |
| Password | Admin123! |
| Roles | Admin |
