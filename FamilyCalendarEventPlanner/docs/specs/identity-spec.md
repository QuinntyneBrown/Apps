...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FamilyCalendarEventPlanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FamilyCalendarEventPlanner",
    "aud": "FamilyCalendarEventPlanner.Api"
}
```
...
| /api/users/* | Admin |
| /api/roles/* | Admin |
| /api/events/* | User or Admin |
| /api/familymembers/* | User or Admin |
| /api/households/* | User or Admin |
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FamilyCalendarEventPlanner",
        "Audience": "FamilyCalendarEventPlanner.Api",
        "ExpiresInHours": 24
    }
}
```
