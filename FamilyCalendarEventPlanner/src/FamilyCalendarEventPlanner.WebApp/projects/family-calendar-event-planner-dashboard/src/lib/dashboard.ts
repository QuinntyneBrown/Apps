...
import { EventsService, FamilyMembersService, ConflictsService, AttendeesService } from '@lib/shared';
import { EventCard, MiniCalendar, EventDialog, EventDialogData, EventDialogResult } from '@lib/shared';
import { CalendarEvent, FamilyMember, ScheduleConflict, EventAttendee } from '@lib/shared';
