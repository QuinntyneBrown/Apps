...
import { EventsService } from '@lib/shared';
import { CalendarEventDto, getEventTypeLabel, getEventStatusLabel } from '@lib/shared';
import { CreateOrEditEventDialog, CreateOrEditEventDialogResult } from '@lib/shared';
