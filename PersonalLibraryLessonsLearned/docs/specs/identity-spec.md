...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PersonalLibraryLessonsLearned system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PersonalLibraryLessonsLearned",
    "aud": "PersonalLibraryLessonsLearned.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PersonalLibraryLessonsLearned",
        "Audience": "PersonalLibraryLessonsLearned.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@personal-library-lessons-learned.local |
| Password | Admin123! |
| Roles | Admin |
