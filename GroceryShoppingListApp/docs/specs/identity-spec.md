...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the GroceryShoppingListApp system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "GroceryShoppingListApp",
    "aud": "GroceryShoppingListApp.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "GroceryShoppingListApp",
        "Audience": "GroceryShoppingListApp.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@grocery-shopping-list-app.local |
| Password | Admin123! |
| Roles | Admin |
