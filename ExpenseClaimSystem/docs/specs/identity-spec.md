...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the ExpenseClaimSystem system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "ExpenseClaimSystem",
    "aud": "ExpenseClaimSystem.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "ExpenseClaimSystem",
        "Audience": "ExpenseClaimSystem.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@expense-claim-system.local |
| Password | Admin123! |
| Roles | Admin |
