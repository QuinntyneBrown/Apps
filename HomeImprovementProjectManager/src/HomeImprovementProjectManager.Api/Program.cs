...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "HomeImprovementProjectManager API",
        Version = "v1",
        Description = "API for managing home improvement projects, budgets, contractors, and materials",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<HomeImprovementProjectManagerContext>();
