...
namespace HomeEnergyUsageTracker.Api.Features.Users;
...
public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, UserDto>
{
    ...
    public CreateUserCommandHandler(IHomeEnergyUsageTrackerContext context, ITenantContext tenantContext, IPasswordHasher passwordHasher, ILogger<CreateUserCommandHandler> logger)
    {
        _context = context;
