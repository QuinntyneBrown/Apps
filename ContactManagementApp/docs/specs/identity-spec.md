...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the ContactManagementApp system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "ContactManagementApp",
    "aud": "ContactManagementApp.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "ContactManagementApp",
        "Audience": "ContactManagementApp.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@contact-management-app.local |
| Password | Admin123! |
| Roles | Admin |
