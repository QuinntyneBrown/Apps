...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the HomeBrewingTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "HomeBrewingTracker",
    "aud": "HomeBrewingTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "HomeBrewingTracker",
        "Audience": "HomeBrewingTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@home-brewing-tracker.local |
| Password | Admin123! |
| Roles | Admin |
