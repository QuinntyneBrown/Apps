...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FreelanceProjectManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FreelanceProjectManager",
    "aud": "FreelanceProjectManager.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FreelanceProjectManager",
        "Audience": "FreelanceProjectManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@freelance-project-manager.local |
| Password | Admin123! |
| Roles | Admin |
