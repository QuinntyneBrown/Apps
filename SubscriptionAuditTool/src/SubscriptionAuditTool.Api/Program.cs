...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "SubscriptionAuditTool API",
        Version = "v1",
        Description = "API for managing subscriptions and categories",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<SubscriptionAuditToolContext>();
