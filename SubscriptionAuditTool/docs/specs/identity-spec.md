...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the SubscriptionAuditTool system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "SubscriptionAuditTool",
    "aud": "SubscriptionAuditTool.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "SubscriptionAuditTool",
        "Audience": "SubscriptionAuditTool.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@subscription-audit-tool.local |
| Password | Admin123! |
| Roles | Admin |
