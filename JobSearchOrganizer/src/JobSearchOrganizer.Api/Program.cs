...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "JobSearchOrganizer API",
        Version = "v1",
        Description = "API for organizing job search activities including applications, companies, interviews, and offers",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<JobSearchOrganizerContext>();
