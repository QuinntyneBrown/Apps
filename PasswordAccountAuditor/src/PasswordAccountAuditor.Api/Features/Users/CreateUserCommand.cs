...
namespace PasswordAccountAuditor.Api.Features.Users;
...
public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, UserDto>
{
    ...
    public CreateUserCommandHandler(IPasswordAccountAuditorContext context, ITenantContext tenantContext, IPasswordHasher passwordHasher, ILogger<CreateUserCommandHandler> logger)
    {
        _context = context;
