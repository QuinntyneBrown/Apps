...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PasswordAccountAuditor system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PasswordAccountAuditor",
    "aud": "PasswordAccountAuditor.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PasswordAccountAuditor",
        "Audience": "PasswordAccountAuditor.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@password-account-auditor.local |
| Password | Admin123! |
| Roles | Admin |
