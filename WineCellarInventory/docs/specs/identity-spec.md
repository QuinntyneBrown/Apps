...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the WineCellarInventory system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "WineCellarInventory",
    "aud": "WineCellarInventory.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "WineCellarInventory",
        "Audience": "WineCellarInventory.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@wine-cellar-inventory.local |
| Password | Admin123! |
| Roles | Admin |
