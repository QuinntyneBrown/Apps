...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "ResumeCareerAchievementTracker API",
        Version = "v1",
        Description = "API for managing career achievements, projects, and skills for resume building",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<ResumeCareerAchievementTrackerContext>();
