...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PersonalHealthDashboard system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PersonalHealthDashboard",
    "aud": "PersonalHealthDashboard.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PersonalHealthDashboard",
        "Audience": "PersonalHealthDashboard.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@personal-health-dashboard.local |
| Password | Admin123! |
| Roles | Admin |
