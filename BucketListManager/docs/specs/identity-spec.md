...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the BucketListManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "BucketListManager",
    "aud": "BucketListManager.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "BucketListManager",
        "Audience": "BucketListManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@bucket-list-manager.local |
| Password | Admin123! |
| Roles | Admin |
