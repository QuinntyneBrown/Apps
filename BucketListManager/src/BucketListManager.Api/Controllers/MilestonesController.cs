...
public class MilestonesController : ControllerBase
{
    ...
    {
        _logger.LogInformation("Getting milestones for user {UserId}", userId);
    ...
    {
        _logger.LogInformation("Creating milestone for bucket list item {BucketListItemId}", command.BucketListItemId);
    ...
    {
        if (milestoneId != command.MilestoneId)
        {
