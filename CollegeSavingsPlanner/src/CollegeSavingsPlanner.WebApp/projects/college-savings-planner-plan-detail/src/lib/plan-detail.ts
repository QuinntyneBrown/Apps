...
import { Plan, Beneficiary, Contribution, Projection } from '@lib/shared';
import { PlanService, BeneficiaryService, ContributionService, ProjectionService } from '@lib/shared';
