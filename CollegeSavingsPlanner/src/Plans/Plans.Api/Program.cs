using Plans.Core;
using Plans.Infrastructure.Data;
...
builder.AddSqlServerDbContext<PlansDbContext>("CollegeSavingsPlannerDb");
builder.Services.AddScoped<IPlansDbContext>(provider => provider.GetRequiredService<PlansDbContext>());
