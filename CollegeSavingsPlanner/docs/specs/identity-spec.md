...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the CollegeSavingsPlanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "CollegeSavingsPlanner",
    "aud": "CollegeSavingsPlanner.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "CollegeSavingsPlanner",
        "Audience": "CollegeSavingsPlanner.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@college-savings-planner.local |
| Password | Admin123! |
| Roles | Admin |
