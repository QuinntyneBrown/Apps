...
public class LetterDeliveredEventTests
{
    [Test]
    public void Constructor_ValidParameters_CreatesEvent()
    {
        ...
        // Act
        var evt = new LetterDeliveredEvent
        {
            LetterId = letterId,
            UserId = userId,
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(evt.DeliveryDate, Is.EqualTo(deliveryDate));
    ...
    public void LetterId_CanBeInitialized_ReturnsCorrectValue()
    {
        ...
        // Act
        var evt = new LetterDeliveredEvent { LetterId = expectedId };
    ...
    public void UserId_CanBeInitialized_ReturnsCorrectValue()
    {
        ...
        // Act
        var evt = new LetterDeliveredEvent { UserId = expectedUserId };
    ...
    [Test]
    public void DeliveryDate_CanBeInitialized_ReturnsCorrectValue()
    {
        // Arrange
        var expectedDeliveryDate = DateTime.UtcNow.AddHours(-2);

        // Act
        var evt = new LetterDeliveredEvent { DeliveryDate = expectedDeliveryDate };

        // Assert
        Assert.That(evt.DeliveryDate, Is.EqualTo(expectedDeliveryDate));
    }
}
