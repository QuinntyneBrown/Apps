...
namespace LetterToFutureSelf.Api.Features.Roles;
...
public class CreateRoleCommandHandler : IRequestHandler<CreateRoleCommand, RoleDto>
{
    ...
    public CreateRoleCommandHandler(ILetterToFutureSelfContext context, ITenantContext tenantContext, ILogger<CreateRoleCommandHandler> logger)
    {
        _context = context;
