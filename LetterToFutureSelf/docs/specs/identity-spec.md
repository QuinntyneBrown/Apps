...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the LetterToFutureSelf system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "LetterToFutureSelf",
    "aud": "LetterToFutureSelf.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "LetterToFutureSelf",
        "Audience": "LetterToFutureSelf.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@letter-to-future-self.local |
| Password | Admin123! |
| Roles | Admin |
