...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the CampingTripPlanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "CampingTripPlanner",
    "aud": "CampingTripPlanner.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "CampingTripPlanner",
        "Audience": "CampingTripPlanner.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@camping-trip-planner.local |
| Password | Admin123! |
| Roles | Admin |
