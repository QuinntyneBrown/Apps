...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the BookReadingTrackerLibrary system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "BookReadingTrackerLibrary",
    "aud": "BookReadingTrackerLibrary.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "BookReadingTrackerLibrary",
        "Audience": "BookReadingTrackerLibrary.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@book-reading-tracker-library.local |
| Password | Admin123! |
| Roles | Admin |
