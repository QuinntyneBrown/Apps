using AnniversaryBirthdayReminder.Api.Features.Users;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace AnniversaryBirthdayReminder.Api.Controllers;
...
public class UsersController : ControllerBase
{
    ...
    public async Task<ActionResult<UserDto>> AddRoleToUser(Guid userId, [FromBody] AddRoleRequest request)
    {
        ...
        try
        {
            var result = await _mediator.Send(new AddRoleToUserCommand
            {
                UserId = userId,
