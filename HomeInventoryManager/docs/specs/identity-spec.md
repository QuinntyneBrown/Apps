...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the HomeInventoryManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "HomeInventoryManager",
    "aud": "HomeInventoryManager.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "HomeInventoryManager",
        "Audience": "HomeInventoryManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@home-inventory-manager.local |
| Password | Admin123! |
| Roles | Admin |
