...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "HomeInventoryManager API",
        Version = "v1",
        Description = "API for managing home inventory items and their value estimates",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<HomeInventoryManagerContext>();
