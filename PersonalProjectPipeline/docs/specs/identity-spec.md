...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PersonalProjectPipeline system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PersonalProjectPipeline",
    "aud": "PersonalProjectPipeline.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PersonalProjectPipeline",
        "Audience": "PersonalProjectPipeline.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@personal-project-pipeline.local |
| Password | Admin123! |
| Roles | Admin |
