...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the TaskPriorityMatrix system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "TaskPriorityMatrix",
    "aud": "TaskPriorityMatrix.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "TaskPriorityMatrix",
        "Audience": "TaskPriorityMatrix.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@task-priority-matrix.local |
| Password | Admin123! |
| Roles | Admin |
