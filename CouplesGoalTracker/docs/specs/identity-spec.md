...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the CouplesGoalTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "CouplesGoalTracker",
    "aud": "CouplesGoalTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "CouplesGoalTracker",
        "Audience": "CouplesGoalTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@couples-goal-tracker.local |
| Password | Admin123! |
| Roles | Admin |
