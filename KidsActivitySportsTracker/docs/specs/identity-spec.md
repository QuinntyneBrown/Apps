...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the KidsActivitySportsTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "KidsActivitySportsTracker",
    "aud": "KidsActivitySportsTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "KidsActivitySportsTracker",
        "Audience": "KidsActivitySportsTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@kids-activity-sports-tracker.local |
| Password | Admin123! |
| Roles | Admin |
