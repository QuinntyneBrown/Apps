...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FamilyTreeBuilder system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FamilyTreeBuilder",
    "aud": "FamilyTreeBuilder.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FamilyTreeBuilder",
        "Audience": "FamilyTreeBuilder.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@family-tree-builder.local |
| Password | Admin123! |
| Roles | Admin |
