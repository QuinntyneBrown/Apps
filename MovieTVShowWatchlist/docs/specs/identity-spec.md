...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MovieTVShowWatchlist system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "MovieTVShowWatchlist",
    "aud": "MovieTVShowWatchlist.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MovieTVShowWatchlist",
        "Audience": "MovieTVShowWatchlist.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@movie-tv-show-watchlist.local |
| Password | Admin123! |
| Roles | Admin |
