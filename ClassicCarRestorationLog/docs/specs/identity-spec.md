...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the ClassicCarRestorationLog system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "ClassicCarRestorationLog",
    "aud": "ClassicCarRestorationLog.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "ClassicCarRestorationLog",
        "Audience": "ClassicCarRestorationLog.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@classic-car-restoration-log.local |
| Password | Admin123! |
| Roles | Admin |
