...
namespace DateNightIdeaGenerator.Api.Features.Roles;
...
public class CreateRoleCommandHandler : IRequestHandler<CreateRoleCommand, RoleDto>
{
    ...
    public CreateRoleCommandHandler(IDateNightIdeaGeneratorContext context, ITenantContext tenantContext, ILogger<CreateRoleCommandHandler> logger)
    {
        _context = context;
