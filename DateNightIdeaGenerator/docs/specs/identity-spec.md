...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the DateNightIdeaGenerator system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "DateNightIdeaGenerator",
    "aud": "DateNightIdeaGenerator.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "DateNightIdeaGenerator",
        "Audience": "DateNightIdeaGenerator.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@date-night-idea-generator.local |
| Password | Admin123! |
| Roles | Admin |
