...
public static class ConfigureServices
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<VideoGameCollectionManagerContext>(options =>
        {
            options.UseSqlServer(connectionString, sqlOptions =>
            {
                sqlOptions.MigrationsAssembly(typeof(VideoGameCollectionManagerContext).Assembly.FullName);
