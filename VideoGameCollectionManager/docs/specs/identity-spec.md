...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the VideoGameCollectionManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "VideoGameCollectionManager",
    "aud": "VideoGameCollectionManager.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "VideoGameCollectionManager",
        "Audience": "VideoGameCollectionManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@video-game-collection-manager.local |
| Password | Admin123! |
| Roles | Admin |
