...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PersonalWiki system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
|-------|-------|
| Username | admin |
| Email | admin@personal-wiki.local |
| Password | Admin123! |
| Roles | Admin |
