...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the BloodPressureMonitor system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "BloodPressureMonitor",
    "aud": "BloodPressureMonitor.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "BloodPressureMonitor",
        "Audience": "BloodPressureMonitor.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@blood-pressure-monitor.local |
| Password | Admin123! |
| Roles | Admin |
