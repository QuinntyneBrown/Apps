...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the CarModificationPartsDatabase system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "CarModificationPartsDatabase",
    "aud": "CarModificationPartsDatabase.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "CarModificationPartsDatabase",
        "Audience": "CarModificationPartsDatabase.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@car-modification-parts-database.local |
| Password | Admin123! |
| Roles | Admin |
