...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the TravelDestinationWishlist system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "TravelDestinationWishlist",
    "aud": "TravelDestinationWishlist.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "TravelDestinationWishlist",
        "Audience": "TravelDestinationWishlist.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@travel-destination-wishlist.local |
| Password | Admin123! |
| Roles | Admin |
