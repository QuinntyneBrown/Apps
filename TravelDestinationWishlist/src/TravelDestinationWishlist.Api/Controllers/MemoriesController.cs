...
public class MemoriesController : ControllerBase
{
    ...
    {
        _logger.LogInformation("Creating memory for user {UserId}", command.UserId);
    ...
    [ProducesResponseType(typeof(MemoryDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult<MemoryDto>> UpdateMemory(Guid memoryId, [FromBody] UpdateMemoryCommand command)
    {
