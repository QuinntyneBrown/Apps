...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the CryptoPortfolioManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "CryptoPortfolioManager",
    "aud": "CryptoPortfolioManager.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "CryptoPortfolioManager",
        "Audience": "CryptoPortfolioManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@crypto-portfolio-manager.local |
| Password | Admin123! |
| Roles | Admin |
