...
public class UpdateUserCommandHandler : IRequestHandler<UpdateUserCommand, UserDto?>
{
    ...
    public UpdateUserCommandHandler(IApplianceWarrantyManualOrganizerContext context, IPasswordHasher passwordHasher, ILogger<UpdateUserCommandHandler> logger)
    {
        _context = context;
