...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "SideHustleIncomeTracker API",
        Version = "v1",
        Description = "API for managing side businesses, income, expenses, and tax estimates",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<SideHustleIncomeTrackerContext>();
