...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the ChoreAssignmentTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "ChoreAssignmentTracker",
    "aud": "ChoreAssignmentTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "ChoreAssignmentTracker",
        "Audience": "ChoreAssignmentTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@chore-assignment-tracker.local |
| Password | Admin123! |
| Roles | Admin |
