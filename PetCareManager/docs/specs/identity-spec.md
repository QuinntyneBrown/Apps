...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PetCareManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PetCareManager",
        "Audience": "PetCareManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@pet-care-manager.local |
| Password | Admin123! |
| Roles | Admin |
