...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PersonalNetWorthDashboard system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PersonalNetWorthDashboard",
    "aud": "PersonalNetWorthDashboard.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PersonalNetWorthDashboard",
        "Audience": "PersonalNetWorthDashboard.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@personal-net-worth-dashboard.local |
| Password | Admin123! |
| Roles | Admin |
