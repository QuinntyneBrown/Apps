...
builder.AddSqlServerDbContext<PurchasesDbContext>("WarrantyReturnPeriodTrackerDb");
builder.Services.AddScoped<IPurchasesDbContext>(provider => provider.GetRequiredService<PurchasesDbContext>());
