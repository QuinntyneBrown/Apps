...
builder.AddSqlServerDbContext<ContactsDbContext>("RoadsideAssistanceInfoHubDb");
builder.Services.AddScoped<IContactsDbContext>(p => p.GetRequiredService<ContactsDbContext>());
