...
builder.AddSqlServerDbContext<VehiclesDbContext>("RoadsideAssistanceInfoHubDb");
builder.Services.AddScoped<IVehiclesDbContext>(p => p.GetRequiredService<VehiclesDbContext>());
