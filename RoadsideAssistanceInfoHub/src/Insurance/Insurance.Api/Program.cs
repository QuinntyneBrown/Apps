...
builder.AddSqlServerDbContext<InsuranceDbContext>("RoadsideAssistanceInfoHubDb");
builder.Services.AddScoped<IInsuranceDbContext>(p => p.GetRequiredService<InsuranceDbContext>());
