...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the RoadsideAssistanceInfoHub system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "RoadsideAssistanceInfoHub",
    "aud": "RoadsideAssistanceInfoHub.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "RoadsideAssistanceInfoHub",
        "Audience": "RoadsideAssistanceInfoHub.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@roadside-assistance-info-hub.local |
| Password | Admin123! |
| Roles | Admin |
