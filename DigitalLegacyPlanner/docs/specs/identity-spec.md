...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the DigitalLegacyPlanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "DigitalLegacyPlanner",
    "aud": "DigitalLegacyPlanner.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "DigitalLegacyPlanner",
        "Audience": "DigitalLegacyPlanner.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@digital-legacy-planner.local |
| Password | Admin123! |
| Roles | Admin |
