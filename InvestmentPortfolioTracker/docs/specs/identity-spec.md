...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the InvestmentPortfolioTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "InvestmentPortfolioTracker",
    "aud": "InvestmentPortfolioTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "InvestmentPortfolioTracker",
        "Audience": "InvestmentPortfolioTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@investment-portfolio-tracker.local |
| Password | Admin123! |
| Roles | Admin |
