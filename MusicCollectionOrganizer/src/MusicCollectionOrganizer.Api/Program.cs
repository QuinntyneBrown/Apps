...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "MusicCollectionOrganizer API",
        Version = "v1",
        Description = "API for managing music collections, albums, artists, and listening logs",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<MusicCollectionOrganizerContext>();
