...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MusicCollectionOrganizer system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "MusicCollectionOrganizer",
    "aud": "MusicCollectionOrganizer.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MusicCollectionOrganizer",
        "Audience": "MusicCollectionOrganizer.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@music-collection-organizer.local |
| Password | Admin123! |
| Roles | Admin |
