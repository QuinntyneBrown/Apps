...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the InjuryPreventionRecoveryTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "InjuryPreventionRecoveryTracker",
    "aud": "InjuryPreventionRecoveryTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "InjuryPreventionRecoveryTracker",
        "Audience": "InjuryPreventionRecoveryTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@injury-prevention-recovery-tracker.local |
| Password | Admin123! |
| Roles | Admin |
