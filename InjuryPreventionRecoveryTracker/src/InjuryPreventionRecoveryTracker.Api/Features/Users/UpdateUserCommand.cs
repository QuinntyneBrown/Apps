...
public class UpdateUserCommandHandler : IRequestHandler<UpdateUserCommand, UserDto?>
{
    ...
    public UpdateUserCommandHandler(IInjuryPreventionRecoveryTrackerContext context, IPasswordHasher passwordHasher, ILogger<UpdateUserCommandHandler> logger)
    {
        _context = context;
