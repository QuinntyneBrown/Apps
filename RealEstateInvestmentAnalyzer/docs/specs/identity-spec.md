...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the RealEstateInvestmentAnalyzer system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "RealEstateInvestmentAnalyzer",
    "aud": "RealEstateInvestmentAnalyzer.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "RealEstateInvestmentAnalyzer",
        "Audience": "RealEstateInvestmentAnalyzer.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@real-estate-investment-analyzer.local |
| Password | Admin123! |
| Roles | Admin |
