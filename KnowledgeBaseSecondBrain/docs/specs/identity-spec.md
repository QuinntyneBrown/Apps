...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the KnowledgeBaseSecondBrain system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "KnowledgeBaseSecondBrain",
    "aud": "KnowledgeBaseSecondBrain.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "KnowledgeBaseSecondBrain",
        "Audience": "KnowledgeBaseSecondBrain.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@knowledge-base-second-brain.local |
| Password | Admin123! |
| Roles | Admin |
