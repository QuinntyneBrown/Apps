...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "WoodworkingProjectManager API",
        Version = "v1",
        Description = "API for managing woodworking projects, materials, and tools",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<WoodworkingProjectManagerContext>();
