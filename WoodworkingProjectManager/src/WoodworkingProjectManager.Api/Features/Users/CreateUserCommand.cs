...
namespace WoodworkingProjectManager.Api.Features.Users;
...
public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, UserDto>
{
    ...
    public CreateUserCommandHandler(IWoodworkingProjectManagerContext context, ITenantContext tenantContext, IPasswordHasher passwordHasher, ILogger<CreateUserCommandHandler> logger)
    {
        _context = context;
