...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the WoodworkingProjectManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "WoodworkingProjectManager",
    "aud": "WoodworkingProjectManager.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "WoodworkingProjectManager",
        "Audience": "WoodworkingProjectManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@woodworking-project-manager.local |
| Password | Admin123! |
| Roles | Admin |
