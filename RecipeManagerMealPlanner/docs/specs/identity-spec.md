...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the RecipeManagerMealPlanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "RecipeManagerMealPlanner",
    "aud": "RecipeManagerMealPlanner.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "RecipeManagerMealPlanner",
        "Audience": "RecipeManagerMealPlanner.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@recipe-manager-meal-planner.local |
| Password | Admin123! |
| Roles | Admin |
