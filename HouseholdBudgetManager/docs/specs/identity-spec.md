...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the HouseholdBudgetManager system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "HouseholdBudgetManager",
    "aud": "HouseholdBudgetManager.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "HouseholdBudgetManager",
        "Audience": "HouseholdBudgetManager.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@household-budget-manager.local |
| Password | Admin123! |
| Roles | Admin |
