...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the LifeAdminDashboard system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "LifeAdminDashboard",
    "aud": "LifeAdminDashboard.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "LifeAdminDashboard",
        "Audience": "LifeAdminDashboard.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@life-admin-dashboard.local |
| Password | Admin123! |
| Roles | Admin |
