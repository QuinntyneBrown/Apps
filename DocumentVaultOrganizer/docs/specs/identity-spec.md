...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the DocumentVaultOrganizer system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "DocumentVaultOrganizer",
    "aud": "DocumentVaultOrganizer.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "DocumentVaultOrganizer",
        "Audience": "DocumentVaultOrganizer.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@document-vault-organizer.local |
| Password | Admin123! |
| Roles | Admin |
