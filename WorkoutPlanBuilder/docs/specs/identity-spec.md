...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the WorkoutPlanBuilder system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "WorkoutPlanBuilder",
    "aud": "WorkoutPlanBuilder.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "WorkoutPlanBuilder",
        "Audience": "WorkoutPlanBuilder.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@workout-plan-builder.local |
| Password | Admin123! |
| Roles | Admin |
