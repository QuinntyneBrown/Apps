...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the BillPaymentScheduler system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "BillPaymentScheduler",
    "aud": "BillPaymentScheduler.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "BillPaymentScheduler",
        "Audience": "BillPaymentScheduler.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@bill-payment-scheduler.local |
| Password | Admin123! |
| Roles | Admin |
