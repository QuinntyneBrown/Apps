...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the NeighborhoodSocialNetwork system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "NeighborhoodSocialNetwork",
    "aud": "NeighborhoodSocialNetwork.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "NeighborhoodSocialNetwork",
        "Audience": "NeighborhoodSocialNetwork.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@neighborhood-social-network.local |
| Password | Admin123! |
| Roles | Admin |
