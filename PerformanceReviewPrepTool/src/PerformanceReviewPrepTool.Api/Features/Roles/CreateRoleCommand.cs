...
namespace PerformanceReviewPrepTool.Api.Features.Roles;
...
public class CreateRoleCommandHandler : IRequestHandler<CreateRoleCommand, RoleDto>
{
    ...
    public CreateRoleCommandHandler(IPerformanceReviewPrepToolContext context, ITenantContext tenantContext, ILogger<CreateRoleCommandHandler> logger)
    {
        _context = context;
