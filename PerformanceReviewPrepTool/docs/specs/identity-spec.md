...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the PerformanceReviewPrepTool system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "PerformanceReviewPrepTool",
    "aud": "PerformanceReviewPrepTool.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "PerformanceReviewPrepTool",
        "Audience": "PerformanceReviewPrepTool.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@performance-review-prep-tool.local |
| Password | Admin123! |
| Roles | Admin |
