...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the ProfessionalNetworkCRM system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "ProfessionalNetworkCRM",
    "aud": "ProfessionalNetworkCRM.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "ProfessionalNetworkCRM",
        "Audience": "ProfessionalNetworkCRM.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@professional-network-crm.local |
| Password | Admin123! |
| Roles | Admin |
