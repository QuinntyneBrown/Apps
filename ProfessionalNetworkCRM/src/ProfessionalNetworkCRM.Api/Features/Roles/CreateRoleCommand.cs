...
namespace ProfessionalNetworkCRM.Api.Features.Roles;
...
public class CreateRoleCommandHandler : IRequestHandler<CreateRoleCommand, RoleDto>
{
    ...
    public CreateRoleCommandHandler(IProfessionalNetworkCRMContext context, ITenantContext tenantContext, ILogger<CreateRoleCommandHandler> logger)
    {
        _context = context;
