...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the FriendGroupEventCoordinator system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "FriendGroupEventCoordinator",
    "aud": "FriendGroupEventCoordinator.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "FriendGroupEventCoordinator",
        "Audience": "FriendGroupEventCoordinator.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@friend-group-event-coordinator.local |
| Password | Admin123! |
| Roles | Admin |
