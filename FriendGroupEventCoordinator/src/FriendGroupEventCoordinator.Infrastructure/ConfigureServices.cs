...
public static class ConfigureServices
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<FriendGroupEventCoordinatorContext>(options =>
        {
            options.UseSqlServer(connectionString, sqlOptions =>
            {
                sqlOptions.MigrationsAssembly(typeof(FriendGroupEventCoordinatorContext).Assembly.FullName);
