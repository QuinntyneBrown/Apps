...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the SkillDevelopmentTracker system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "SkillDevelopmentTracker",
    "aud": "SkillDevelopmentTracker.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "SkillDevelopmentTracker",
        "Audience": "SkillDevelopmentTracker.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@skill-development-tracker.local |
| Password | Admin123! |
| Roles | Admin |
