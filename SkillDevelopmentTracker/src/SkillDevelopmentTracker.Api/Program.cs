...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "SkillDevelopmentTracker API",
        Version = "v1",
        Description = "API for managing skills, courses, certifications, and learning paths",
    });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<SkillDevelopmentTrackerContext>();
