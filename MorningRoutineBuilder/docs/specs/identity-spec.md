...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the MorningRoutineBuilder system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "MorningRoutineBuilder",
    "aud": "MorningRoutineBuilder.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "MorningRoutineBuilder",
        "Audience": "MorningRoutineBuilder.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@morning-routine-builder.local |
| Password | Admin123! |
| Roles | Admin |
