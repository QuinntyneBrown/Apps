...
### 1.1 Purpose
This document specifies the identity and authentication requirements for the NutritionLabelScanner system. It defines how users authenticate, how JWT tokens are generated and validated, and how role-based access control is implemented.
...
```json
{
    ...
    "iat": 1704067200,
    "exp": 1704153600,
    "iss": "NutritionLabelScanner",
    "aud": "NutritionLabelScanner.Api"
}
```
...
```json
{
    "Jwt": {
        ...
        "Issuer": "NutritionLabelScanner",
        "Audience": "NutritionLabelScanner.Api",
        "ExpiresInHours": 24
    }
}
```
...
|-------|-------|
| Username | admin |
| Email | admin@nutrition-label-scanner.local |
| Password | Admin123! |
| Roles | Admin |
